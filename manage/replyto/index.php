...
<body marginwidth="0" marginheight="0" topmargin="0" bottommargin="0" rightmargin="0" leftmargin="0" onload="display_ct();">
    ...
    <table width="100%" height="100%" align="center" cellspacing="0">
		...
		-webkit-box-shadow: 0px 0px 17px 10px #000000; box-shadow: 0px 0px 17px 10px #000000;">
                                                    ...
                                                    <form method="post" action="send_replyto.php">
                                                    <table align="center">
                                                            ...
                                                            <tr>
                                                                <td height="">
                                                                    ...
                                                                    <font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" color="#000">
                                                                        ...
                                                                        <font size="+1" color="#08298A">Email Subject  </font>
				...
				-webkit-box-shadow: 0px 0px 8px 3px #000000; box-shadow: 0px 0px 8px 3px #000000;" required="" placeholder="Enter subject">
                                                            ...
                                                            <tr>
                                                                <td height="">
                                                                    ...
                                                                    <font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" color="#000">
                                                                        ...
                                                                        <font size="+1" color="#08298A">Reply to Email </font>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input name="replyto_email" type="email" value="" style="width:500px; height:37px; font-family: Verdana; font-size: 13px; font-weight: light; color:#000000; 
				background-color: #E6E6E6; border: solid 1px #333; padding: 8px; 
				-moz-border-radius: 2px; -webkit-border-radius: 2px; -khtml-border-radius: 2px; border-radius: 2px;
				-webkit-box-shadow: 0px 0px 8px 3px #000000; box-shadow: 0px 0px 8px 3px #000000;" required="" placeholder="Reply to email address">
                                                            ...
                                                            <tr>
                                                                <td height="">
                                                                    ...
                                                                    <font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" color="#000">
                                                                        ...
                                                                        <font size="+1" color="#08298A">Reply To Subject </font>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input name="replyto_subject" type="text" value="" style="width:500px; height:37px; font-family: Verdana; font-size: 13px; font-weight: light; color:#000000; 
				background-color: #E6E6E6; border: solid 1px #333; padding: 8px; 
				-moz-border-radius: 2px; -webkit-border-radius: 2px; -khtml-border-radius: 2px; border-radius: 2px;
				-webkit-box-shadow: 0px 0px 8px 3px #000000; box-shadow: 0px 0px 8px 3px #000000;" required="" placeholder="Enter reply to subject ">
                                                            ...
                                                            <tr>
                                                                <td height="">
                                                                    ...
                                                                    <font face="Lucida Grande, Lucida Sans Unicode, Lucida Sans, DejaVu Sans, Verdana, sans-serif" size="2" color="#000">
                                                                        ...
                                                                        <font size="+1" color="#08298A">Senders Email (Cpanel Mail) </font>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input name="senders_email" type="email" value="" style="width:500px; height:37px; font-family: Verdana; font-size: 13px; font-weight: light; color:#000000; 
				background-color: #E6E6E6; border: solid 1px #333; padding: 8px; 
				-moz-border-radius: 2px; -webkit-border-radius: 2px; -khtml-border-radius: 2px; border-radius: 2px;
				-webkit-box-shadow: 0px 0px 8px 3px #000000; box-shadow: 0px 0px 8px 3px #000000;" required="" placeholder="Enter senders email ">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input type="submit" name="submitbutton" value="Next >>>" style="width:500px; height:40px;
